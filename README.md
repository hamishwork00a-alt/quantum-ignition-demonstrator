...
```mermaid
timeline
    title 量子光刻技術遷移路徑(original schedule, revised new one from 2025, 9)
    2024 Q3 ： 完成 300mm 晶圓量子塗布驗證
    2025 Q1 ： 與 ASML 高 NA 模塊兼容改造
    2026 Q4 ： 實現 0.3nm 量子微影量產
    2027 ： 推出桌面型量子光刻機 (佔地 < 5m²)
```
